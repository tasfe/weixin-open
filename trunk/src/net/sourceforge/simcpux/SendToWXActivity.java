	...
	private void initView() {
		...
		findViewById(R.id.send_img).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				case MMAlertSelect2: 
						{
							String path = SDCARD_ROOT + "/aa.jpg";
...
//								getImageIntent.putExtra("crop", true);
//								getImageIntent.putExtra("return-data", true);
//								startActivityForResult(getImageIntent, 0x010);
//												
//							
//						
//						}break;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 0x010:{
				...
				//	Bitmap bmp = MediaStore.Images.Media.getBitmap(getApplicationContext().getContentResolver(), returnedPictureUri );
	...
	private static final int RETURN_FOR_IMAGE=0x010;
}
